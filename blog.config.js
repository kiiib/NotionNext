...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Jianbin Liu, Technical Artist',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jianbin Liu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Technical Artist', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jianbinliu.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Jianbin Liu, Technical Artist', // 网站关键词 英文逗号隔开
  ...
  CONTACT_ARTSTATION: process.env.NEXT_PUBLIC_CONTACT_ARTSTATION || '', // 您的instagram地址
